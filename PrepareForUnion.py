...
TC_Karayolları = {
    ...
    "Azami Hız Sınırlaması 90": 96,
    "Dikkat": 97,
    "Sağa Tehlikeli Devamlı Virajlar": 98,
    "Gevşek Şev (T-10)": 99, 
    "4.80 Metreden Yüksek Araç Giremez":100,
    "Gevşek Malzemeli Zemin (T-9)": 101, 
    "Ehli Hayvan Geçebilir (T14-a)": 102,
    "Tehlikeli Eğim (İniş) (T-3a)": 103,
    "Tehlikeli Eğim (Çıkış) (T-3b)": 104,
    "Soldan daralan kaplama (T-4c)": 105,
    "Sağdan daralan kaplama (T-4b)": 106,
    "Her iki taraftan daralan kaplama (T-4a)": 107,
}
...
mahmouddello = {
    ...
    3: ["hizSiniri70", 64],
    4: ["hizSiniri90", 96],
    5: ["sonraki_kavsak_gecis_hakki", 24],
    6: ["buzlanma", 15],
    7: ["dur", 40],
    8: ["duz_veya_sag", 1],
    9: ["duz_veya_sol", 14],
    10: ["engebeli_yol", 0],
    11: ["gecis_yask_sonu", 48],
    12: ["gecis_yasak", 37],
    13: ["genel_uyari", 97],
    14: ["saga_teklikeli_viraj", 17],
    15: ["kaygan_yol", 42],
    16: ["ana_yol", 35],
    17: ["saga_tehlikeli_yol", 98],
    18: ["mecburi_sag", 18],
    19: ["sola_tehlikeli_viraj", 4],
    20: ["mecburi_sol", 53],
    21: ["trafik_isiklari", 45],
    22: ["yayalar", 11],
    23: ["yol_calismasi", 39],
    24: ["yol_ver", 34],
    25: ["zorunlu_doner_kavsak", 79],
    26: ["u_donusu", 90],
    27: ["u_donusu_yasak", 6],
    28: ["gevsek_yamac", 99],
    29: ["4.80_metreden_yuksek_arac_giremez", 100],
    30: ["gesek_malzemeli_yol", 101],
    31: ["ehli_hayvan_gecebilir", 102],
    32: ["yaya_gecidi", 5],
    33: ["duraklamak_veya_park_yasak", 74],
    34: ["mecburi_sag_veya_sol", 81],
    35: ["sola_tehlikeli_devamlı_viraj", 91],
    36: ["okul_gecidi", 13],
    37: ["eds", 84],
    38: ["tehlikeli_egim_cikis", 104],
    39: ["iki_yandan_yol_daralmasi", 107],
    40: ["sagdan_ana_yola_giris", 72],
    41: ["tehlikeli_egim_inis", 103],
    42: ["okul_gecidi_B-14b", 2],
    43: ["sagdan_yol_daralmasi", 106],
    44: ["soldan_yol_daralmasi", 105]
}
